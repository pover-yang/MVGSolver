#include "solver_essential_matrix_three_point_sweeny.h"


namespace solver {
    constexpr size_t EssentialMatrixThreePointSolverSweeny::sampleSize() {
        return 3;
    }

    constexpr size_t EssentialMatrixThreePointSolverSweeny::maximumSolutions() {
        return 4;
    }

    bool EssentialMatrixThreePointSolverSweeny::estimateModel(const cv::Mat &data, const size_t *sample, std::vector<Model> &models) {
    ...
    int EssentialMatrixThreePointSolverSweeny::qep_div_1_q2(const Eigen::Matrix3d &A, const Eigen::Matrix3d &B, const Eigen::Matrix3d &C,
    ...
    int EssentialMatrixThreePointSolverSweeny::solve_quartic_real(double b, double c, double d, double e, double roots[4]) {
    ...
    void EssentialMatrixThreePointSolverSweeny::solve_cubic_single_real(double c2, double c1, double c0, double &root) {
    ...
    void EssentialMatrixThreePointSolverSweeny::detpoly3(const Eigen::Matrix<double, 3, 3> &A, const Eigen::Matrix<double, 3, 3> &B,
                                                         double coeffs[7]) {
    ...
    double EssentialMatrixThreePointSolverSweeny::sign(const double z) {
        return z < 0 ? -1.0 : 1.0;
    }
}
